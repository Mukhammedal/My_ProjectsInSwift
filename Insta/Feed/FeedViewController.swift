...
//  Instagram
//
//  Created by Mukhammedali on 08.05.2023.
//
...
//        view.backgroundColor = .white
    ...
    private var items: [FeedItemType] = [
        ...
        .post(FeedPostItemInfo(userImage: UIImage(named: "dog")!, username: "Some_dog", postSubtitles: "Sponsored", postImage: UIImage(named: "dog")!, numberOfLikes: 123, comment: CommentShortInfo(username: "Another_dog", commentText: "hahaha lol =)"))),
        .post(FeedPostItemInfo(userImage: UIImage(named: "dog")!, username: "Some_dog", postSubtitles: "Sponsored", postImage: UIImage(named: "dog")!, numberOfLikes: 123, comment: CommentShortInfo(username: "Another_dog", commentText: "hahaha lol =)"))),
        .post(FeedPostItemInfo(userImage: UIImage(named: "dog")!, username: "Some_dog", postSubtitles: "Sponsored", postImage: UIImage(named: "dog")!, numberOfLikes: 123, comment: CommentShortInfo(username: "Another_dog", commentText: "hahaha lol =)"))),
        .post(FeedPostItemInfo(userImage: UIImage(named: "dog")!, username: "Some_dog", postSubtitles: "Sponsored", postImage: UIImage(named: "dog")!, numberOfLikes: 123, comment: CommentShortInfo(username: "Another_dog", commentText: "hahaha lol =)")))
        ]
}
//    .stories([FeedStoriesItemCellInfo(image: UIImage(named: "dog"), username: "Ali_2004", isAddButtonVisible:true,isNewStory: false)])
...
private extension FeedViewController{
    func initialize() {
        ...
        tableView.register(FeedPostCeel.self, forCellReuseIdentifier: String(describing: FeedPostCeel.self))
    ...
    func makeLeftBarButtonItems() -> [UIBarButtonItem] {
        ...
        let dropDownButtonItem = UIBarButtonItem(title: nil,image: UIImage(systemName: "chevron.down"), target: self,action: nil,
...
extension FeedViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .post(let post):
            let cell = tableView.dequeueReusableCell(withIdentifier: String(describing: FeedPostCeel.self), for: indexPath) as! FeedPostCeel
